...
{   
    ...
    function viewTable(){
        ...
        $ticket->setFornecedor($_POST['fornecedor']);
        $ticket->setVeiculo($_POST['veiculo']);
        $ticket->setMotorista($_POST['motorista']);
        $ticket->setDataInicial($data_inicial);
        $ticket->setDataFinal($data_final);
