...
--
-- Host: localhost
-- Tempo de geração: 12/06/2020 às 02:15
...
(7, 11, 48, '123.00', '2020-07-02', 41, 1, 1, 0),
(8, 11, 48, '123.00', '2020-06-25', 41, 1, 1, 0);
...
(183, 11, 30, 10000, 14, 40, 'Luan Roberto Ribeiro', '2020-06-09 06:15:00', 'PPS2314', '3.20', '32000.00', 0),
(184, 11, 21321, 123, 14, 40, 'thalles', '2020-06-09 11:04:00', 'PPS1232', '10.00', '1230.00', 0),
(185, 11, 12, 10, 14, 41, 'Paulino', '2020-11-06 02:52:00', 'PPS21312', '2.00', '20.00', 0),
(186, 11, 123, 10000, 14, 45, 'Paulina Robertina', '2020-11-06 04:11:00', 'PPPS123', '3.00', '30000.00', 0),
(187, 11, 22, 100, 14, 40, '22', '2020-11-06 04:15:00', '2', '2.00', '200.00', 0),
(188, 11, 21123, 490, 14, 41, 'Palunioa', '2020-11-06 04:25:00', 'PPS2', '2.00', '980.00', 0),
(189, 11, 82782, 20000, 14, 46, 'Motoro', '2020-11-06 04:28:00', 'PPS23', '3.20', '64000.00', 0);
...
(51, 11, 42, 40, 41, 123, 100, '2020-06-11 00:00:00', 0);
...
INSERT INTO `tbtanque` (`id_tanque`, `id_cliente`, `nome_tanque`, `capacidade`, `id_combustivel`, `id_medida`, `flag_excluido`) VALUES
(40, 11, 'TAN. 01', 20000, 43, 4, 0),
(41, 11, 'T-003', 1000, 45, 4, 0),
(42, 11, 'BioD 02', 1000, 49, 4, 0),
(43, 11, 'Dev H2', 11000, 43, 4, 0),
(44, 11, 'p23', 2200, 45, 4, 0),
(45, 11, 'GAS BR 2927 RI', 20000, 46, 4, 1),
(46, 11, 'Petro Brasil 28236 Es - 9', 2000000, 50, 4, 1),
(47, 11, 'T43', 20000, 45, 4, 1);
...
--
ALTER TABLE `tbcartao_virtual`
  MODIFY `id_cartao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbmov_entrada`
  MODIFY `id_entrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;

--
-- AUTO_INCREMENT de tabela `tbmov_saida`
--
ALTER TABLE `tbmov_saida`
  MODIFY `id_saida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `tbtanque`
  MODIFY `id_tanque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
